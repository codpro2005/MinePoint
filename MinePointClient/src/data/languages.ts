...
interface ILanguage {
    ...
    productAds: string;
    productNoAds: string;
    productFrom8FrancsPerMonth: string;
...
export const languages: ILanguages = {
    german: {
        ...
        productFrom8FrancsPerMonth: 'Ab 8 CHF / Monat',
        ...
        productMinePointPackageBonusDescription: 'Für eine einmalige Zahlung von 5 CHF werden wir dir den Server selber aufsetzen.',
        ...
        authenticateMailRequired: 'Bitte eine Email eingeben',
        authenticateMailInvalid: 'Bitte eine valide Email eingeben',
    ...
    english: {
        ...
        productAds: 'Ads',
        productNoAds: 'No ads!',
        productFrom8FrancsPerMonth: 'From 8 CHF / month',
        ...
        contactMailRequired: 'Please enter an E-Mail',
        ...
        authenticateMail: 'E-Mail',
        authenticatePassword: 'Password',
        authenticatePasswordConfirm: 'Password confirm',
        authenticateUsernameRequired: 'Please enter a username',
        authenticateMailRequired: 'Please enter an E-Mail',
        authenticateMailInvalid: 'Please enter a valid E-Mail',
    ...
    chinese: {
        ...
        productAds: '收购',
        productNoAds: '没有广告！',
        productFrom8FrancsPerMonth: '每月CHF 8起',
        productBuyNow: '立即购买',
